...
- [Azure 데이터 보호](/azure/security/fundamentals/protection-customer-data): Azure는 기본적으로 그리고 고객 옵션으로 고객에게 강력한 데이터 보안을 제공합니다.

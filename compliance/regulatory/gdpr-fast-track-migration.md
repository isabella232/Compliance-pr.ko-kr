...
![PowerShell — 관리자 권한으로 실행합니다.](../media/fasttrack-powershell_image.png)

![PowerShell — 앱을 변경할 수 있도록 허용합니다.](../media/fasttrack-run-powershell_image.png)

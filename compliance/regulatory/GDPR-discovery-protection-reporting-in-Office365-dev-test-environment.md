...
3. 브라우저의 새 탭에 **https://**\<YourTenantName\>**.sharepoint.com** 를 입력합니다.
...
3. 새 창에서 다음 정보를 제공합니다. 이름: IBAN 검색 b 검색 대상: **검색할 특정 사이트를 선택**(**+** 클릭)하고 사이트의 URL을 입력합니다. **https://**\<YourTenantName\>**.sharepoint.com/** c. **추가** 를 클릭한 다음 **OK** 를 클릭합니다. 경고가 표시되면 **OK** 를 클릭합니다.
...
15. **정책을 켜거나 먼저 테스트를 수행하시겠습니까?** 에서 다음 설정을 선택하고 **다음** 을 클릭합니다.
    a. **먼저 테스트 수행** 에 대한 옵션을 선택합니다 b. **테스트 모드인 경우 정책 팁 표시** 에 대한 확인란 선택
...
22. **새로 만들기** - **전자 메일 메시지** 를 클릭하고 다음을 입력합니다.
    ...
    - **받는 사람:** \<a personal email address\>
    - **제목:** GDPR 테스트

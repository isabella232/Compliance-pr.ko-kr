...
| _ *범주** | **정의** |
|:------------ |:-------------- |
| **_없음_* _ | 정보가 노출, 변경, 삭제 또는 다른 방식으로 손상되지 않았습니다. |
| _*_개인 정보 보호 위반_*_ | 납세자, 직원, 수익자 등의 중요한 개인 데이터가 액세스되었거나 노출되었습니다. |
| _*_독점 위반_*_ | PCII(보호되는 중요한 인프라 정보) 등의 분류되지 않은 소유 정보가 액세스되었거나 노출되었습니다. |
| _*_무결성 손실_*_ | 중요한 정보 또는 소유 정보가 변경되었거나 삭제되었습니다. |

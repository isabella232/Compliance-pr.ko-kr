...
Windows Enterprise용 Microsoft 데이터 프로세서 서비스에서 사용하는 감지 프로세스는 Windows Enterprise용 데이터 프로세서 서비스의 기밀성, 무결성 및 가용성에 위협이 되는 이벤트를 검색하도록 고안되었습니다. 다음과 같은 여러 이벤트가 조사를 트리거할 수 있습니다.
...
- **개인 정보 위반:** 개인 데이터와 관련된 보안 인시던트의 하위 유형입니다. 처리 절차는 보안 인시던트와 다르지 않습니다.
...
Windows Enterprise용 데이터 프로세서 서비스 팀은 CSS(고객 서비스) 및 고객 AM(계정 관리자) 또는 TAM(기술 계정 관리자)과 같은 추가 Microsoft 직원에게 알리도록 선택할 수도 있습니다. 이러한 개인은 고객과 밀접하게 관련되어 있는 경우가 많으며 더욱 빠른 수정이 이루어지게 하는 데 도움이 될 수 있습니다.

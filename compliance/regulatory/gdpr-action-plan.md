...
GDPR은 EU(유럽 연합) 회원국 국민에게 제품과 서비스를 제공하거나 EU 국민과 관련된 데이터를 수집 및 분석하는 회사, 정부 기관, 비영리 조직 및 기타 조직에 새로운 규칙을 도입했습니다. GDPR은 귀하 또는 귀사가 어디에 있는지 관계없이 적용됩니다.
...
- [Microsoft 서비스 및 GDPR에 대해 자세히 알아보기](gdpr.md)

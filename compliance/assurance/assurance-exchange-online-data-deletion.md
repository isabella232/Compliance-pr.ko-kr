...
## <a name="soft-deleted-and-hard-deleted-mailboxes"></a>Soft-Deleted 및 Hard-Deleted 사서함

일시 삭제 된 사용자 사서함은 Microsoft 365 관리 센터 또는 Remove-Mailbox cmdlet을 사용 하 여 삭제 되었으며 30 일 이내에 여전히 Azure Active Directory 휴지통에 남아 있는 사서함입니다. 다음 방법 중 하나를 사용 하 여 사서함을 일시 삭제할 수 있습니다.
...
## <a name="soft-deleted-and-hard-deleted-items"></a>Soft-Deleted 및 Hard-Deleted 항목

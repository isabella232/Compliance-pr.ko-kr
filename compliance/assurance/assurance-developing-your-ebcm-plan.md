...
이 항목에서는 Microsoft 365 종속성을 고려하여 비즈니스 연속성 계획을 개발하는 방법에 대한 지침을 제공합니다. 여기에서 비즈니스 기능을 분석하고 Microsoft 365 서비스에 종속되는 기능을 식별하는 방법을 권장합니다. 서비스 장애가 발생할 수 있고 이러한 가능성에 대비하면서 이 분석을 수행합니다.

...
| [사서함 콘텐츠 검색 및 유지](https://docs.microsoft.com/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) | 사서함에 대 한 In-Place eDiscovery 또는 In-Place 보존 설정에 대 한 자세한 정보를 제공 합니다. |
